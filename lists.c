...
/**
 * add_node_to_start - Adds a node to the beginning of the linked list
...
/**
 * print_list_strings - Prints only the str element of a linked list
...
/**
 * free_list_nodes - Frees all the nodes of a linked list
